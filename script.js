// Definición de materias por semestre
const semestres = [
  {
  ...
  },
  {
    ...
    materias: [
      { id: "tec_solidos", nombre: "Tec. Farmacéutica Medicamentos Sólidos", requiere: ["operaciones"], desbloquea: ["tec_liquidos"] },
  ...
  },
  {
    ...
    materias: [
      { id: "tec_liquidos", nombre: "Tec. Farmacéutica Medicamentos Líquidos", requiere: ["tec_solidos"], desbloquea: ["tec_semisolidos"] },
      ...
      { id: "farmacologia2", nombre: "Farmacología II", requiere: ["farmacologia1"], desbloquea: ["clinica", "farmacoter"] },
      { id: "toxicologia", nombre: "Toxicología", requiere: ["farmacologia1"], desbloquea: ["ocupacional"] },
      { id: "diseno_proyecto", nombre: "Diseño de Proyecto de Investigación", requiere: ["metodologia"], desbloquea: ["trabajo_grado"] },
  ...
  },
  {
    ...
    materias: [
      { id: "tec_semisolidos", nombre: "Tec. Farmacéutica Semisólidos y Magistrales", requiere: ["tec_liquidos"], desbloquea: ["cosmeticos"] },
      ...
      { id: "electiva4", nombre: "Electiva de Profundización IV", requiere: ["electiva3"], desbloquea: ["electiva5"] },
    ]
  },
  {
    ...
    materias: [
      ...
      { id: "electiva5", nombre: "Electiva de Profundización V", requiere: ["electiva4"], desbloquea: ["electiva6"] },
    ]
  },
  {
    ...
    materias: [
      ...
      { id: "electiva6", nombre: "Electiva de Profundización VI", requiere: ["electiva5"], desbloquea: ["electiva7", "electiva8", "electiva9"] },
    ]
  },
  {
    ...
    materias: [
      ...
      { id: "electiva7", nombre: "Electiva de Profundización VII", requiere: ["electiva6"] },
      { id: "electiva8", nombre: "Electiva de Profundización VIII", requiere: ["electiva6"] },
      { id: "electiva9", nombre: "Electiva de Profundización IX", requiere: ["electiva6"] },
    ]
  },
];
...
semestres.forEach(sem => {
  ...
  sem.materias.forEach(mat => {
    ...
    btn.addEventListener("click", () => {
      ...
      mat.desbloquea?.forEach(id => {
        const requisitos = estadoMaterias[id].requiere;
        const aprobados = requisitos.every(req => estadoMaterias[req]?.aprobada);
        if (aprobados) {
          estadoMaterias[id].element.classList.remove("bloqueada");
        } else {
          estadoMaterias[id].element.classList.add("bloqueada");
